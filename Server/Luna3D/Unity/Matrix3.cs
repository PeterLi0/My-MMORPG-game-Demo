...
//     <id value="$Id: Matrix3.cs 3293 2012-05-21 11:56:22Z borrillis $"/>
// </file>
...
namespace Luna3D
{
    ...
    public struct Matrix3
    {
        ...
        public Vector3 ToEulerAnglesXYZ()
        {
            ...
            //pAngle = Mathf.ASin(this.m01);
            pAngle = Mathf.Asin(this.m01);
            if (pAngle < Mathf.PI / 2)
            {
                if (pAngle > -Mathf.PI / 2)
                {
                    yAngle = Mathf.Atan2(this.m21, this.m11);
                    rAngle = Mathf.Atan2(this.m02, this.m00);
                }
                else
                {
                    // WARNING. Not a unique solution.
                    var fRmY = (float)Mathf.Atan2(-this.m20, this.m22);
            ...
            {
                // WARNING. Not a unique solution.
                var fRpY = Mathf.Atan2(-this.m20, this.m22);
                rAngle = 0.0f; // any angle works
                yAngle = fRpY - rAngle;
            }
