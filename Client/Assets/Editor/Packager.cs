...
public class Packager
{
    ...
    static void AddSingleBuildMap(string path, string pattern)
    {
        ...
        for (int i = 0; i < files.Length; i++)
        {
            ...
            AssetBundleBuild build = new AssetBundleBuild();
            string str = files[i].Remove(0, path.Length + 1);
            build.assetBundleName = str.Replace(".prefab", AppConst.ExtName);
    ...
    static void HandleExampleBundle()
    {
        ...
        //AddBuildMap("PromptPanel" + AppConst.ExtName, "*.prefab", "Assets/Examples/Builds/Prompt");
        //AddBuildMap("MessagePanel" + AppConst.ExtName, "*.prefab", "Assets/Examples/Builds/Message");
        ...
        //AddBuildMap("Button" + AppConst.ExtName, "*.prefab", "Assets/Resources/UI");
        //AddBuildMap("LoginWnd" + AppConst.ExtName, "*.prefab", "Assets/Resources/UI");
