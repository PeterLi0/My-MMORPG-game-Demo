namespace Luna3D
{
    ...
    public struct Mathf
    {
        ...
        //[ExcludeFromDocs]
        //public static float SmoothDamp(float current, float target, ref float currentVelocity, float smoothTime, float maxSpeed, float dt)
        //{
        ...
        //[ExcludeFromDocs]
        //public static float SmoothDamp(float current, float target, ref float currentVelocity, float smoothTime, float dt)
        //{
        //    float deltaTime = dt;
        ...
        public static float SmoothDamp(float current, float target, ref float currentVelocity, 
            float smoothTime, /*[DefaultValue("Mathf.Infinity")]*/ float maxSpeed, /*[DefaultValue("Time.deltaTime")]*/ float deltaTime)
        {
